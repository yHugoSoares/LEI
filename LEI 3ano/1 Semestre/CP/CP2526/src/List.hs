...
-- (c) MP-I (1998/9-2006/7) and CP (2005/6-2025/26)
...
fac :: Integer -> Integer
fac = hyloList facf facg

facf = either (const 1) mul

facg = (id -|- (split succ id)) . outNat
...
-- (4.12) Towers of Hanoi ------------------------------------------------------

hanoi' = hyloList g f
f (d,0) = i1()
f (d,n+1) = i2((d,n),(not d,n))
g = either nil h
h(x,y) = y ++ [x] ++ y
