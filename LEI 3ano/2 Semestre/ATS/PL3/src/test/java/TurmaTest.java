...
class TurmaTest {
    ...
    void addAlunoTest() {
        t.addAluno(a);
        assertTrue(
            t.containsAluno("A00000"),
            "Aluno inserido nao se encontra na turma"
        );
    }
    ...
    void getAlunoTest() {
        ...
        try {
            ...
            assertEquals(
                a,
                r,
                "Alfredo inserido e obtido de turma nao e igual ao original"
            );
    ...
    void mediaTest() {
        try {
            ...
            assertEquals(
                ...
                t.media(),
                0.05,
                "Media calculada com valor incorreto"
            );
