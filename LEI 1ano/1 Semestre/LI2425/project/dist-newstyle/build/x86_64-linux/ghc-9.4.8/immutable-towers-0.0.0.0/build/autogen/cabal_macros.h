...
/* package immutable-towers-0.0.0.0 */
#ifndef VERSION_immutable_towers
#define VERSION_immutable_towers "0.0.0.0"
#endif /* VERSION_immutable_towers */
#ifndef MIN_VERSION_immutable_towers
#define MIN_VERSION_immutable_towers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_immutable_towers */
...
#define CURRENT_PACKAGE_KEY "immutable-towers-0.0.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "immutable-towers-0.0.0.0-inplace"
